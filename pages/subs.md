...
- Unless modelling a _tubular daylighting device_ ([TDD](https://bigladdersoftware.com/epx/docs/25-2/input-output-reference/group-daylighting.html#daylightingdevicetubular "Tubular Daylighting Device")), a fenestrated surface must _align_ with its _base_ surface, i.e. they both must share the same 3D plane and the _subsurface_ must _fit_ within _base_ surface boundaries.
